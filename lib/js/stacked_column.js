...
StackedColumnChart.prototype._drawTooltip = function() {
  ...
  self.$tooltip = self.$wrapper.append('div')
    .attr('class', 'tooltip')
    .style('position', 'absolute')
    .style('opacity', '0')
    .style('pointer-events', 'none');

  self.$tooltip.append('span').attr('class', 'tooltip-label');
  self.$tooltip.append('span').attr('class', 'tooltip-value');
