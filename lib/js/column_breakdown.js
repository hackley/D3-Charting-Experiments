...
ColumnBreakdownChart.prototype._calcColumnWidth = function() {
  var width = this._totalWidth() / this.normalizedDataSet.length;
  width -= this.settings.columnSpacing;
  return width;
};

ColumnBreakdownChart.prototype._calcColumnPositionX = function(i) {
  return i * (this._totalWidth() / this.normalizedDataSet.length);
};

ColumnBreakdownChart.prototype._calcColumnPositionY = function(d) {
...
ColumnBreakdownChart.prototype._columnCenter = function(i) {
...
ColumnBreakdownChart.prototype._drawTotals = function($columns) {
  var self = this;
  $columns.append('text')
    .text(function(d, i) {
    ...
    .attr('class', 'total')
    .attr('y', function(d, i) {
      return self._calcColumnPositionY(self.normalizedDataSet[i]);
    })
    .attr("x", function(d, i) {
      return self._columnCenter(i);
    })
